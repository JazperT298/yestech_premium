...
public class EducatorListFragment extends Fragment {
    ...
    private ImageView iv_Search, iv_AddEducator, iv_Back, iv_Close;
    private TextInputEditText et_SearchUser;
    private SwipeRefreshLayout swipe_EducatorList;
    private ConstraintLayout indicator_empty_record;
    private RecyclerView rv_EducatorList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_educator_list, container, false);
        context = getContext();
        return view;
    }
    ...
    private void initializeUI(){
        ...
        iv_AddEducator = view.findViewById(R.id.iv_AddEducator);
        iv_Back = view.findViewById(R.id.iv_Back);
        iv_Close = view.findViewById(R.id.iv_Close);
        et_SearchUser = view.findViewById(R.id.et_SearchUser);
        swipe_EducatorList = view.findViewById(R.id.swipe_EducatorList);
        rv_EducatorList = view.findViewById(R.id.rv_EducatorList);
        ...
        iv_Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                iv_AddEducator.setVisibility(View.GONE);
        ...
        iv_Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                iv_AddEducator.setVisibility(View.VISIBLE);
        ...
        iv_AddEducator.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
